#!/bin/bash
################################################################################
# Script for installing Odoo V17 on Ubuntu 20 LTS (could be used for other version too)
# Author: Blisqy
...
#-------------------------------------------------------------------------------
# Make a new file:
# sudo nano odoo_installation.sh
# Place this content in it and then make the file executable:
# sudo chmod +x odoo_installation.sh
...
## https://www.odoo.com/documentation/17.0/setup/install.html#deb ):
...
#Choose the Odoo version which you want to install. For example: 17.0, 16.0, 15.0, 14.0, 13.0, 12.0, 11.0, 10.0, 9.0, 8.0, 7.0 or saas-6. When using 'trunk' the master version will be installed.
...
# Default-Stop: 0 1 6
# Short-Description: Felixent Enterprise Business Applications
# Description: ODOO Business Applications V17.0
### END INIT INFO
